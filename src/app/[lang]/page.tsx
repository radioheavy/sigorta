        ...
        <div className="border-4 border-black p-8 sm:p-12 bg-white">
          <div className="border-b-4 border-black pb-8 mb-8">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-black uppercase leading-tight tracking-tighter">
              {t.title1}
              <br />
              <span className="bg-accent px-2">{t.title2}</span>
            </h1>
          </div>
      ...
      <section className="pb-16">
        <div className="border-4 border-black bg-black text-white p-8 flex flex-col sm:flex-row items-center justify-around gap-6">
          <div className="text-center">
            <p className="text-3xl font-black text-accent">{t.trust100}</p>
            <p className="text-xs uppercase tracking-wider mt-1">{t.trustAnonymous}</p>
          </div>
          <div className="w-px h-12 bg-gray-600 hidden sm:block" />
          <div className="text-center">
            <p className="text-3xl font-black text-accent">{t.trustDSGVO}</p>
            <p className="text-xs uppercase tracking-wider mt-1">{t.trustGDPR}</p>
          </div>
          <div className="w-px h-12 bg-gray-600 hidden sm:block" />
          <div className="text-center">
            <p className="text-3xl font-black text-accent">{t.trustSofort}</p>
            <p className="text-xs uppercase tracking-wider mt-1">{t.trustInstant}</p>
          </div>
        </div>
      </section>
    </div>
